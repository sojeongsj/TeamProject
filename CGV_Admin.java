...
public class CGV_Admin extends JFrame implements ActionListener {
	...
	public CGV_Admin() {
		...
		ImageIcon icon = new ImageIcon(CGV_Admin.class.getResource("/image/CGV_Admin_ICon.png"));
		bg.setIcon(icon);
	...
	private void showTotalPanel() {
		...
		// try {
		// String result = YourSQLQueryMethod();
		// JLabel resultLabel = new JLabel("<html>" + result + "</html>");
		// resultLabel.setBounds(15, 10, 440, 315);
		// } catch (SQLException e) {
		// e.printStackTrace();
		// JOptionPane.showMessageDialog(this, "SQL 실행 중 오류가 발생했습니다.");
		// }
